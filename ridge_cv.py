...
cv = run_cv(n_folds, ridge, X_train, y_train)
print("Cross Validation done")
print("\nFor alpha = 30:")
print(cv)
cross_val_df = pd.DataFrame(cv)
cross_val_df.to_csv('cross_val_ridge_30.csv', index=False)
...
predictions_df.to_csv('predicted_values_ridge_30.csv', index=False)
...
# save the dataframe to a csv file
feat_imp_df.to_csv('feature_importance_ridge_30.csv', index=False)
